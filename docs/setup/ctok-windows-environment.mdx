---
title: "Claude Code 在Windows中设置环境变量有几种方法："
description: "Claude Code 在Windows中设置环境变量有几种方法： - Ctok Claude Code 安装配置指南"
category: "setup"
source: "ctok"
originalUrl: "https://docs.ctok.ai/claude-code-windows-env-setup"
