...
![Claude 欢迎界面](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fclaude-welcome.82a5b3c6.jpg&w=3840&q=75)
...
## [Vibe Coding 的迭代速度](#vibe-coding-的迭代速度)
...
## [从传统 Editor AI 的转换](#从传统-editor-ai-的转换)
...
### [在合适的时机手动 compact](#在合适的时机手动-compact)
...
### [Command 和 Hooks](#command-和-hooks)
...
![麦克风](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fmic.4f847683.jpg&w=3840&q=75)
...
### [Opus 远强于 Sonnet](#opus-远强于-sonnet)
...
本文基于王巍 (onevcat) 的原创文章 [一个半月高强度 Claude Code 使用后感受](https://onevcat.com/2025/08/claude-code/) 进行扩展和本地化。

**原作者**: 王巍 (onevcat)  
**原始链接**: [https://onevcat.com/2025/08/claude-code/](https://onevcat.com/2025/08/claude-code/)  
**发布日期**: 2025年8月3日

感谢王巍分享这个宝贵的 Claude Code 实战经验，为 AI 辅助开发提供了深刻的洞察和实用的建议。本文保留了所有技术细节、代码示例和最佳实践说明，同时进行了适当的格式优化。
...
[Vibe Coding 的迭代速度](#vibe-coding-的迭代速度)[从传统 Editor AI 的转换](#从传统-editor-ai-的转换)[认识 CC 的边界和长处](#认识-cc-的边界和长处)[思考先行还是实践先行](#思考先行还是实践先行)[小步迭代还是放飞自我](#小步迭代还是放飞自我)[任务规模和上下文制约](#任务规模和上下文制约)[任务拆解是关键](#任务拆解是关键)[使用 Subagent](#使用-subagent)[在合适的时机手动 compact](#在合适的时机手动-compact)[善用命令和周边工具](#善用命令和周边工具)[Command 和 Hooks](#command-和-hooks)[MCP](#mcp)[编译、分析和测试](#编译分析和测试)[Code 之外，大有可为](#code-之外大有可为)[体感降智和更多限制](#体感降智和更多限制)[Opus 远强于 Sonnet](#opus-远强于-sonnet)[时间玄学](#时间玄学)[降智疑云](#降智疑云)[限制的阴霾](#限制的阴霾)[一些应对策略](#一些应对策略)[总结和未来展望](#总结和未来展望)[来源和致谢](#来源和致谢)